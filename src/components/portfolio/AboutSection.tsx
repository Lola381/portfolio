...
export function AboutSection() {
  return (
    <section id="about" className="relative min-h-screen flex flex-col items-center justify-center px-5 sm:px-8 md:px-10 pt-40 sm:pt-48 md:pt-56 pb-20 overflow-hidden">
      <FadeIn delay={0.1} x={-80} y={0} duration={0.9} className="absolute top-[12%] left-[1%] sm:left-[2%] md:left-[4%]">
      ...
      <FadeIn delay={0.15} x={80} y={0} duration={0.9} className="absolute top-[12%] right-[1%] sm:right-[2%] md:right-[4%]">
      ...
      <FadeIn delay={0.25} x={-80} y={0} duration={0.9} className="absolute bottom-[2%] left-[3%] sm:left-[6%] md:left-[10%]">
      ...
      <FadeIn delay={0.3} x={80} y={0} duration={0.9} className="absolute bottom-[2%] right-[3%] sm:right-[6%] md:right-[10%]">
      ...
      <div className="flex flex-col items-center gap-10 sm:gap-14 md:gap-16 relative z-10">
        ...
        <AnimatedText
          text="I'm a software developer pursuing my Master's in Computer Applications at CHRIST University. I specialize in full-stack web development, AI/ML systems, and native Android apps. From architecting computer vision pipelines to building scalable mobile apps, I focus on engineering solutions that are technically rigorous and genuinely useful."
